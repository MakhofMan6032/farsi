...
local function check_member_super(cb_extra, success, result) 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
      ...
      save_data(_config.moderation.data, data) 
     local text = 'سوپر گروه زیر نظارت TeleSudo TEAM قرار گرفت!' 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
     -- Group configuration removal 
      ...
      save_data(_config.moderation.data, data) 
     local text = 'سوپرگروه از نظارت TeleSudo TEAM خارج شد' 
      return reply_msg(msg.id, text, ok_cb, false) 
    end 
  end 
end 
...
local title ="درباره گروه: ["..result.title.."]\n\n" 
local admin_num = "تعداد ادمین ها: "..result.admins_count.."\n" 
local user_num = "تعداد نفرات موجود در گروه: "..result.participants_count.."\n" 
local kicked_num = "تعداد کیک شدگان: "..result.kicked_count.."\n" 
...
local function run(msg, matches) 
   ...
   local data = load_data(_config.moderation.data) 
      ...
      unlock_group_operator(msg, data, target), 
         ...
         if matches[2]:lower() == 'آرتی آل' then 
      ...
      unlock_group_operator(msg, data, target), 
         ...
         if matches[2]:lower() == 'آرتی ال' then 
      ...
      if matches[1] == 'حذف موت' and is_momod(msg) then 
         local chat_id = msg.to.id 
         if matches[2] == 'audio' then 
         local msg_type = 'Audio' 
